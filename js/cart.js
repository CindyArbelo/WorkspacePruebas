...
articles.forEach(product => {
    ...
    costCell.textContent = product.unitCost;
    ...
    quantityInput.id = `quantityInput_${product.productId}`;
    quantityInput.addEventListener("input", () => {
        updateSubtotal(product, quantityInput, subtotalCell);
        updateTotal();
    });
    ...
    subtotalCell.id = `subtotalCell_${product.productId}`;
    updateSubtotal(product, quantityInput, subtotalCell);
    totalCost += product.unitCost * product.count;
...
function updateSubtotal(product, quantityInput, subtotalCell) {
  // Obtén la cantidad del input del producto actual
